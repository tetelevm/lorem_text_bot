...
messages = {
    ...
    "generate": {
        "help": (
            "🅰️ <code>/generate</code> генерирует случайную фразу абсурда\n"
            "\n"
    ...
    "generate_absurd": {
        "help": (
            "🔤 <code>/generate_absurd</code> случайным образом генерирует абсурдотекст\n"
            "\n"
    ...
    "chinese": {
        "help": (
            "🔤 <code>/chinese</code> выдаёт перевод случайных китайских символов\n"
            "\n"
