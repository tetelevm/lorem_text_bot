...
messages = {
    "already_run": "🕓 Я уже думаю над задачей, подождите.",
    ...
    "translate": {
        "help": (
            ...
            "\n"
            "!! Справка писалась в момент, когда всё было хорошо, но позже переводчики перестали"
            " нормально работать, и справка стала немного некорректной. Когда всё настроится"
            " нормально, то справка обновится. !!\n"
            "\n"
            ...
            " значения <i>{translators}</i>, по умолчанию <i>lin</i>\n"
            ...
            "\n"
            "📗 Примеры:\n"
            "- &lt;<code>/translate</code>&gt; - переводит текст с помощью LingvaNex"
            " с распознанного на русский\n"
            "- &lt;<code>/translate lin</code>&gt; - переводит текст с помощью LingvaNex"
            " с распознанного на русский\n"
            "- &lt;<code>/translate uk</code>&gt; - переводит текст с помощью LingvaNex"
            " с украинского на русский\n"
            "- &lt;<code>/translate en ja</code>&gt; - переводит текст с помощью LingvaNex"
