...
messages: _Messages = {
    ...
    "start": {
        ...
        "admin": (
            ...
            "🅰️ /generate - сгенерировать <b>фразу</b>\n"
            "🈲️ /chinese - перевести случайные <b>китайские символы</b>\n"
            "🇼️ /gen - сгенерировать <b>фразу</b> через Watson\n"
            "🔤 /generate_absurd - сгенерировать немного <b>абсурдоткекста</b>\n"
            "📃 /lorem - сгенерировать <b>псевдотекст</b>\n"
            "📃 /lorem_tt - сгенерировать <b>псевдотекст</b> на татарском\n"
    ...
    "help": {
        ...
        "admin": (
            ...
            "🈲 /chinese - беру случайное количество <b>китайских символов</b> и перевожу их\n"
            "\n"
            "* 🇼️ /gen - <b>генерирую абсурдную фразу</b> с использованием лорема и"
            ...
            "\n"
            "* 📃 /lorem_full - генерирует псевдотекст (как lorem), но оставляет знаки препинания\n"
            "\n"
            "* 📃 /lorem_tt - генерирует псевдотекст на татарском языке\n"
            "\n"
            ...
            "<code>/help /lorem_full</code>\n"
            "<code>/help /lorem_tt</code>\n"
        ...
        "gen": (
            "🇼 /gen генерирует случайную фразу абсурда\n"
            "\n"
            "🧠 Суть работы в том, что бот генерирует <b>одно предложение лорема</b> и <b>переводит"
            ...
            "\n"
            "📗 Примеры:\n"
            "- &lt;<code>/gen</code>&gt; - генерирует рандомную фразу"
        ),
        ...
        "lorem": (
            ...
            f" &lt;{', '.join(lorem_generator.languages)}&gt;; параметр можно не указывать\n"
        ...
        "lorem_full": (
            "📋 /lorem_full генерирует <b>псевдотекст</b>.\n"
            "\n"
            "🧠 Вызов полностью аналогичен вызову /lorem с той разницей, что"
            " <code>/lorem_full</code> не очищает текст от символов пунктуации.\n"
            "См. <code>/help /lorem</code>\n"
        ),
        "lorem_tt": (
            "📃 /lorem_tt генерирует <b>псевдотекст</b> на татарском языке.\n"
            "\n"
            "🧠 Вызов полностью аналогичен `/lorem tt`.\n"
            "\n"
            "🪛 Не поддерживает параметров.\n"
            "\n"
            "📗 Примеры:\n"
            "- &lt;<code>/lorem_tt</code>&gt; - генерация псевдотекста\n"
        ),
        "translate": (
            ...
            f" значения &lt;<i>{', '.join(text_translator.translator_names)}</i>&gt;, по умолчанию"
            " <i>wat</i>\n"
            ...
            "Стандартные, которые есть почти во всех переводчиках:"
            f" &lt;<i>{', '.join(shared_languages)}</i>&gt;\n"
            "\n"
            "📗 Примеры:\n"
...
# for @BotFather
bot_info = {
    "user": "Бот для генерации нейротекста, основанный на странности обучения переводчиков.",
    "admin": "Расширенная версия бота для генерации нейротекста.",
    "test": "Тестовая версия бота",
}
